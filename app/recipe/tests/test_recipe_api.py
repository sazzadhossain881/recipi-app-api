...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        for ingredint in payload['ingredients']:
    ...
    def test_create_recipe_with_existing_ingredient(self):
        ...
        payload = {
            ...
            'time_minutes': 60,
            'price': Decimal('2.50'),
            'ingredients': [{'name': 'Lemon'}, {'name': 'Fish Souse'}],
        }
    ...
    def test_filter_by_tags(self):
        ...
        tag1 = Tag.objects.create(user=self.user, name='Nonveg')
    ...
    def test_filter_by_ingredients(self):
        ...
        r2 = create_recipe(user=self.user, title='Chicken Cash')
        in1 = Ingredient.objects.create(user=self.user, name='Feta Cheese')
        in2 = Ingredient.objects.create(user=self.user, name='Chicken')

        r1.ingredients.add(in1)
        r2.ingredients.add(in2)
        r3 = create_recipe(user=self.user, title='Red Latil Dal')
...
class ImageUploadTest(TestCase):
    ...
    def test_upload_image(self):
        ...
        with tempfile.NamedTemporaryFile(suffix='.jpg') as image_file:
            ...
            res = self.client.post(url, payload, formart='multipart')
